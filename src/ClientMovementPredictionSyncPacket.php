...
class ClientMovementPredictionSyncPacket extends DataPacket implements ServerboundPacket{
	...
	public const FLAG_LENGTH_975 = 128;
	public const FLAG_LENGTH_944 = 127;
	...
	public static function create(
		...
		if($flags->getLength() !== self::FLAG_LENGTH_975 && $flags->getLength() !== self::FLAG_LENGTH_944){
			throw new \InvalidArgumentException("Input flags must be " . self::FLAG_LENGTH_975 . " or " . self::FLAG_LENGTH_944 . " bits long");
		}
	...
	protected function decodePayload(ByteBufferReader $in) : void{
		$flagLength = $this->protocolId >= 975 ? self::FLAG_LENGTH_975 : self::FLAG_LENGTH_944;
		$this->flags = BitSet::read($in, $flagLength);
